...
<html lang="en">
  <head>
    ...
    <title><?=$name?> - Free Download Music</title>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
		  ...
		  <a href="#" class="navbar-brand">Download Music</a>        </div>
            ...
            <div class="panel panel-info" >
                    ...
                    <div class="panel-body">
						<div class="text-center">
							...
							<h2><?=$name?></h2>
							<p><small><i>Waktu Rilis Music: <?=base64_decode($json->albuminfo->date)?></i></small></p>
						</div><hr>
